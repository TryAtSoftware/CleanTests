...
public static class TestParameters
{
    ...
    public static IEnumerable<EnvironmentSetup> ConstructObservableCombinatorialMachineSetups()
    {
        var setup1 = new EnvironmentSetup("Setup #1", 26).WithCategory("A", 3).WithCategory("B", 2).WithCategory("C", 3).WithCategory("D", 3);
        ...
        var setup2 = new EnvironmentSetup("Setup #2", 6).WithCategory("A", 2).WithCategory("B", 2).WithCategory("C", 2).WithCategory("D", 2).WithCategory("E", 2);
        ...
        var setup6 = new EnvironmentSetup("Setup #6", 10);
        ...
        var setup7 = new EnvironmentSetup("Setup #7", 0);
        ...
        var setup8 = new EnvironmentSetup("Setup #8", 32);
        ...
        var setup9 = new EnvironmentSetup("Setup #9", 48);
